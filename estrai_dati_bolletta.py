...
def estrai_dati_bolletta(testo: str) -> dict:
    try:
        prompt = (
            ...
            "- quota_fissa_vendita (cerca nella sezione Quora fissa il corrispondente importo dopo la dicitura 'di cui spesa per vendita energia elettrica' deve essere una quota euro al mese solo il valore numerico con punto decimale)\n"  #modifica 05-09-2025
            ...
            f"{testo[:7000]}" # AGGIUNGI "- quota_fissa_vendita (cerca nella sezione Quora fissa il corrispondente importo dopo la dicitura 'di cui spesa per vendita energia elettrica' deve essere una quota euro al mese solo il valore numerico con punto decimale)\n" 
        )

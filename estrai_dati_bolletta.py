...
def estrai_dati_bolletta(testo: str) -> dict:
    try:
        prompt = (
            ...
            "- quota_fissa_vendita (cerca subito dopo la sezione Quota fissa il corrispondente importo dopo la dicitura 'di cui spesa per vendita energia elettrica' deve essere una quota euro al mese solo il valore numerico con decimale se non lo trovi metti 10)\n"  #modifica 05-09-2025
